...
#
# Refer to spyce.py
# CVS: $Id: error.py 578 2005-04-19 04:09:33Z jbe $
##################################################

from spyceModule import spyceModule
import spyceException, spyceUtil
import os
...
def spyceHandler(errorModule, spyceCode, type='file'):
  ...
  try:
    s, file = None, None
    if type=='file':
      file = spyceUtil.url2file(spyceCode, errorModule._api.getFilename())
