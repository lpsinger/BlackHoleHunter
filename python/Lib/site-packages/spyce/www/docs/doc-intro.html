...
<table border=0 width="100%"><tr>
  <td nowrap valign=bottom>
    <b><font face="arial, helvetica" size="-1"><big>Documentation - Introduction</big></font></b><br clear=all>
  </td>
...
but Spyce is far more than a JSP clone.  Out of the box, Spyce supports
component-oriented programming a la JSF, Tapestry, or ASP.NET, as well
as the model-view-controller style popularized by Struts.
Spyce also keeps the Python philosophy of powerful simplicity; you will
not have to deal with any XML configuration files in Spyce.
...
<p>
Spyce's <a
href="doc-add_perf.html">performance</a> is comparable to the
